...
/*
 *
 * Class that finds all duplicate audio files
 *
 */
public class DuplicateAudios extends Duplicate {

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        runParallelTask("Audios");
    }
    ...
    protected void checkDuplicateFiles() {
        ...
        try (Cursor cursor = getApplicationContext().getContentResolver().query(
            ...
            while (cursor.moveToNext()) {
                ...
                Uri contentUri = ContentUris.withAppendedId(MediaStore.Audio.Media.getContentUri(MediaStore.VOLUME_EXTERNAL), id);
