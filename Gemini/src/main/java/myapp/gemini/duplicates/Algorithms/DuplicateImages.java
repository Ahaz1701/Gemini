...
/*
 *
 * Class that finds all duplicate images
 *
 */
public class DuplicateImages extends Duplicate {

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        runParallelTask("Images");
    }
    ...
    protected void checkDuplicateFiles() {
        ...
        try (Cursor cursor = getApplicationContext().getContentResolver().query(
            ...
            while (cursor.moveToNext()) {
                ...
                Uri contentUri = ContentUris.withAppendedId(MediaStore.Images.Media.getContentUri(MediaStore.VOLUME_EXTERNAL), id);
